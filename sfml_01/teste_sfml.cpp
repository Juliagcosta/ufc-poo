...
int main() {
    sf::Texture hero_text { loadTexture("hero.png") };
    sf::Texture monster_text { loadTexture("monster.png") };
    sf::Texture fundo_text { loadTexture("fundo.jpg") };

    const int STEP {100};

    Entity hero(3, 4, STEP, hero_text);
    Entity monster(3, 1, STEP, monster_text);
    Board fundo(7, 5, STEP, fundo_text);

    sf::RenderWindow window(sf::VideoMode(fundo.nc * STEP, fundo.nl * STEP), "Quest do Heroi");
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            if (event.type == sf::Event::Closed) {
                ...
                moveEntity(event.key.code, hero, {sf::Keyboard::Left, sf::Keyboard::Up, sf::Keyboard::Right, sf::Keyboard::Down});
                moveEntity(event.key.code, monster, {sf::Keyboard::A, sf::Keyboard::W, sf::Keyboard::D, sf::Keyboard::S});
            }
        }
